        ...
        <div class="login-container">
            ...
            <form method="POST" action="{{ route('login.post') }}">
                ...
                <div class="d-flex justify-content-between align-items-center mb-3">
                    ...
                    <a href="{{ route('password.form') }}" class="text-decoration-none">Forgot password?</a>
                </div>
                ...
                <p class="text-center mt-3">
                    Don't have an account yet? <a href="{{ route('register.form') }}" class="text-decoration-none">Register</a>
                </p>
            </form>
        </div>
    </div>
