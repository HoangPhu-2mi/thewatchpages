...
<head>
    ...
    <style>
        ...
        .container { max-width: 1100px; margin-top: 40px; background: white; padding: 30px; border-radius: 12px; }
        .summary { background: #fafafa; border-left: 1px solid #ddd; padding: 20px; }
        .summary h5 { border-bottom: 1px solid #ddd; padding-bottom: 10px; }
        .btn-dark { border-radius: 0; font-weight: 600; }
...
<div class="container">
    ...
    <p><strong>Step 2:</strong> Information</p>
    ...
    <div class="row">
        ...
        <div class="col-md-7">
            ...
            <form method="POST" action="{{ route('checkout.store') }}">
                ...
                <input name="company" class="form-control mb-3" placeholder="Company name (optional)">
                <input name="address" class="form-control mb-3" placeholder="Street address">
                <input name="apartment" class="form-control mb-3" placeholder="Apartment, suite, unit, etc. (optional)">
                <div class="row mb-3">
                    <div class="col"><input name="country" class="form-control" placeholder="Country / Region *"></div>
              
                </div>
                <input name="city" class="form-control mb-3" placeholder="Town / City *">
                <input name="phone" class="form-control mb-3" placeholder="Phone *">
                <textarea name="note" class="form-control mb-3" placeholder="Notes (optional)"></textarea>
                <input type="hidden" name="total" value="{{ $total }}">
                <button class="btn btn-dark w-100">CONTINUE TO PAYMENT</button>
            </form>
        </div>
            ...
            <div class="d-flex align-items-center mb-3">
                ...
                <div>
                    ...
                    <div>
                        ...
                        <span class="price-new ms-2">${{ number_format($item['price'], 2) }}</span>
                    </div>
                </div>
            </div>
            @endforeach
